...
def main(num_stages, num_users, d, m, L, pj, filename=''):
    ...
    if filename == '':
        ...
        print("filename is null, generating thetam")
    ...
    # "halp" represents that users in the same cluster follow a uniform distribution but the distribution among clusters is arbitrary
...
if __name__== "__main__":
    ...
    main(num_stages = 10, num_users = 100, d = 20, m = 10, L = 20, pj = 0)
